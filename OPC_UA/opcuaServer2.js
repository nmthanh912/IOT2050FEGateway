...
;(async () => {
    ...
    const server = new OPCUAServer({
        ...
        resourcePath: '/UA/MyLittle', // this path will be added to the endpoint resource name
        buildInfo: {
    ...
    namespace.addVariable({
        componentOf: device,
        nodeId: 'ns=1;s=1022FFAA',
        browseName: 'MyVariable3',
        dataType: 'Double',
        value: {
            get: () => new Variant({dataType: DataType.Double, value: variable3}),
        },
    })
