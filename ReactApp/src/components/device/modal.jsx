...
export default function DeviceModal({ show, onHide, device, mode }) {
  ...
  const setDescription = (description) =>
    setDraftInfo({ ...draftInfo, description });
  ...
  const handleUploadFile = (file) => {
    try {
      ...
      const tagListOffset =
        file.data.findIndex((val) => val[0] === "Tag List") + 1;
      const configOffset =
        file.data.findIndex((val) => val[0] === "Configurations") + 1;
      const deviceInfoOffset =
        file.data.findIndex((val) => val[0] === "Device Info") + 2;
      ...
      if (mode === "edit") {
        if (
          removedNullData[deviceInfoOffset][7].toLowerCase() !==
          draftInfo.protocol.value.toLowerCase()
        )
      ...
      for (let i = 0; i < tagListLength; ++i) {
        ...
        for (let j in removedNullData[tagListOffset]) {
          tag[removedNullData[tagListOffset][j]] =
            removedNullData[tagListOffset + i + 1][j];
        }
        newTagList.push(tag);
      }
      ...
      for (let i in removedNullData[configOffset]) {
        newConfig[removedNullData[configOffset][i]] =
          removedNullData[configOffset + 1][i];
      }
            ...
            <div className="row">
              <Form.Group className="col-6">
                ...
                <Form.Select
                  ...
                  onChange={(e) =>
                    setDraftInfo({ ...draftInfo, byteOrder: e.target.value })
                  }
                  required
              ...
              <Form.Group className="col-6">
                ...
                <Form.Select
                  ...
                  onChange={(e) =>
                    setDraftInfo({ ...draftInfo, wordOrder: e.target.value })
                  }
                  required
                  disabled={draftInfo.protocol.value === "OPC_UA"}
                >
              ...
              <Form.Group className="col-6">
                ...
                <Form.Control
                  ...
                  onChange={(e) =>
                    setDraftInfo({
                      ...draftInfo,
                      scanningCycle: parseInt(e.target.value),
                    })
                  }
                  required
                />
              ...
              <Form.Group className="col-6">
                ...
                <Form.Control
                  ...
                  onChange={(e) =>
                    setDraftInfo({
                      ...draftInfo,
                      minRespTime: parseInt(e.target.value),
                    })
                  }
                  required
                  min={1}
            ...
            {mode === "add" && (
              <Form.Group className="mt-2">
                ...
                <Form.Text className="text-muted">
                  This number indicates how many anologous devices you want to
                  create.
                </Form.Text>
              </Form.Group>
            )}
