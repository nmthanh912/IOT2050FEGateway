...
Các method POST, PUT, DELETE trả về kết quả thực thi **(KQTT)**, cụ thể là key
của dữ liệu nếu thực thi thành công, ngược lại trả về error message:
...
| 3   | PUT    | /device/:`id` | Chỉnh sửa thông tin một device có id cho trước. Dữ liệu gửi trong body tương tự _POST_ method | KQTT                                               |
...
| 3   | PUT    | /tag/:`id` | Sửa một tag với ID cho trước. Dữ liệu gửi trong body tương tự _POST_ method.                     | KQTT                                                                                       |
...
| 3   | PUT    | /protocol/:`name` | Cập nhật thông tin của một protocol có tên cho trước. Dữ liệu gửi trong body tương tự _POST_ method                                    | KQTT                                                 |
...
| 3   | PUT    | /config/:`deviceId` | Chỉnh sửa 1 config. Dữ liệu gửi trong body tương tự _POST_ method.                                                                                                                      | KQTT                                          |
